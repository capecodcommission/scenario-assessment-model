...
class Scenario {
  ...
  constructor(ScenarioID, createdBy, treatments, nReducFert, nReducSW, nReducSeptic, nReducGW, nReducAtt,  nReducInEmbay, typeIDArray, techMatrixArray, areaID, treatmentIDCustomArray, subWatershedArray, tblWinArray, ftCoeffArray, areaName, technologiesArray, nConversion, embayNCalc, fullTechMatrix, fullTechnologies) {
  ...
  getTreatmentsData() {
    ...
    return models.Scenario_Wiz.findOne({
      where: {ScenarioID: this.ScenarioID}, 
      include: [models.Treatment_Wiz]
    })
  }
  ...
  scenarioTreatments() {
    ...
    return this.treatments.map((i) => {
      var newTreatment = new Treatment(i.TreatmentType_ID, i.Nload_Reduction, i.Treatment_Class)
